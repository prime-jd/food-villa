...
const RestaurantMenu = () => {
    ...
    return !restaurant ? (
        ...
        <div className="restaurant-menu mt-2 min-h-screen w-auto ">
            <div className="restaurant-summary flex h-100 justify-center align-middle overflow-y-hidden bg-slate-800 text-cyan-50 ">
                <img
                            ...
                            <div className="menu-item flex flex-col " key={item?.id}>
                                ...
                                <div>
                                    ...
                                    <div className="text-right ">
                                        <button className="add-btn  justify-center pr-1.5 w-16 h-100 bg-orange-700   text-end rounded-lg"> ADD+</button>
                                    </div>
                                </div>
